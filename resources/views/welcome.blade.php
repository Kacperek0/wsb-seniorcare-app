    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-info text-uppercase" id="mainNav">
        ...
        <section id="seniorcare" class="page-section bg-light text-muted mb-0 pt-5" id="about">
            <div class="container">
                ...
                <img src="/img/volunteer.png" class="rounded">
        ...
        <section id="about" class="page-section bg-light text-muted mb-0 pt-5" id="about">
            <div class="container">
                ...
                <div class="row mt-4 pb-5">
                    <div class="col-lg-12 ms-auto text-center mt-4 pb-5"><p><em><h2>SeniorCare to platforma zrzeszająca osoby poszukujące pomocy oraz osoby gotowe takiej pomocy udzielić.
                    ...
                    <img src="/img/close.png" class="rounded">
                </div>
            </div>
        </section> 
        ...
        <footer class="footer text-center bg-secondary pt-5 pb-5" id="contact">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h3 class="text-uppercase mb-4"><i class="bi bi-headset" style="font-size: 2rem; color: darkgray;"></i>  Main contact</h3>
                        <p class="mb-0">
                            02034614444 (Mon to Fri, 9am to 5pm)<br>
                            Email: support@seniorcare.com<br>
